 ...
 */
export type OutputTroubleshootReportTaskOptions = {
    inventory: Inventory
 ...
 * issues encountered
 */
export type OutputTroubleshootReportTask = {
    /**
     ...
     */
    run: (options: OutputTroubleshootReportTaskOptions) => Promise<string | undefined>;
}
