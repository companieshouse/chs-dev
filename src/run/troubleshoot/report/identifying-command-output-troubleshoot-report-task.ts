...
/**
 * An OutputTroubleshootReportTask which will prompt the user to supply the
 * command that failed and write it to the troubleshooting context
 */
export class IdentifyingCommandOutputTroubleshootReportTask {
    async run ({
        context
...
export default new IdentifyingCommandOutputTroubleshootReportTask();
