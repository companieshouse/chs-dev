...
export default class SpringBootInitializrLinkPrompt {
    ...
    async make (newServiceSpec: Partial<NewServiceSpec>) {
        ...
        while (promptAttempts <= SpringBootInitializrLinkPrompt.MAXIMUM_RETRIES_FOR_PROMPT) {
        ...
        if (promptAttempts > SpringBootInitializrLinkPrompt.MAXIMUM_RETRIES_FOR_PROMPT) {
